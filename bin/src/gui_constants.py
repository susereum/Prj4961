...
WORKSHOP_TMP_DIRECTORY = os.path.join(os.getcwd(), "workshop_creator_gui_resources", "creatorImportTemp")
...
DOWNLOAD_LOCATION = os.path.join(os.getcwd(), "workshop_creator_gui_resources")
